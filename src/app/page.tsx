...
import { ArrowRight } from "lucide-react" // Removed unused Link import
  ...
  return (
    ...
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      ...
      <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
        Chat with your PDF like never before! Upload and start a lively conversation with your documents in seconds.
      </p>
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="mt-2 font-bold text-4xl test-gray-900 sm:text-5xl">Start Chatting In Minutes.</h2>
            <p className="mt-4 text-lg text-gray-600">
              Chatting to your PDF files has never been easier than with Liber.
            </p>
          </div>
        </div>
        ...
        <ol className='my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0'>
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                We&apos;ll process your files and make it ready for you to chat with.
              </span>
            </div>
          </li>
         
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 - pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:top-4">
              <span className="text-sm font-medium text-blue-600">Step 3</span>
              <span className="text-xl font-semibold">Start Asking questions</span>
              <span className="mt-2 text-zinc-700">
                It&apos;s that simple. Try out Liber today,
